...
try:
    ...
    os.system('pip install mechanize requests futures==2 > /dev/null')
    os.system('python run.py')
print('\n\033[1;32m[•]   JOIN MY TELEGRAM CHANNEL FOR MORE TOOL');time.sleep(3)
os.system('xdg-open https://t.me/dnhboys1')
print('\n\033[1;36m[•]   WELCOME TO HAIDER GAMING TOOL...');time.sleep(3)
...
try:
	prox= requests.get('https://raw.githubusercontent.com/Haider-143/data/main/proxies.txt').text
...
android_models=[]
try:
    xx = requests.get('https://raw.githubusercontent.com/Haider-143/data/main/strings.txt').text.splitlines()
    for line in xx:
        android_models.append(line)
except:pass
usr=[]
try:
    xd=requests.get('https://raw.githubusercontent.com/Haider-143/data/main/ua.txt').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
...
logo=("""                  
 ...
 _   _   ___  ___________ ___________       __    ___  _____ 
| | | | / _ \|_   _|  _  \  ___| ___ \     /  |  /   ||____ |
| |_| |/ /_\ \ | | | | | | |__ | |_/ /_____`| | / /| |    / /
|  _  ||  _  | | | | | | |  __||    /______|| |/ /_| |    \ \
| | | || | | |_| |_| |/ /| |___| |\ \      _| |\___  |.___/ /
\_| |_/\_| |_/\___/|___/ \____/\_| \_|     \___/   |_/\____/ 
                                                             
                                                             
                                                             
\x1b[1;97m[\x1b[1;95m•\x1b[1;97m] \x1b[1;94mAUTHOR   \x1b[1;95m: \x1b[1;94mHAIDER GAMING
\x1b[1;97m[\x1b[1;95m•\x1b[1;97m] \x1b[1;94mFACEBOOK \x1b[1;95m: \x1b[1;94RHAIDER GAMING
\x1b[1;97m[\x1b[1;95m•\x1b[1;97m] \x1b[1;94mWHATSAPP \x1b[1;95m: \x1b[1;94m+8801840561907      
\x1b[1;97m[\x1b[1;95m•\x1b[1;97m] \x1b[1;94mTelegram \x1b[1;95m: \x1b[1;94mD-N-H-BOYS1
\x1b[1;97m[\x1b[1;95m•\x1b[1;97m] \x1b[1;94mGITHUB   \x1b[1;95m: \x1b[1;94mHaider-143
\x1b[1;97m[\x1b[1;95m•\x1b[1;97m] \x1b[1;94mVERSION  \x1b[1;95m:\x1b[1;92m 1        
\x1b[1;97m-----------------------------------------------------    """)
...
try:
    ...
    proxy = requests.get('https://github.com/HAIDER-143').text.splitlines()
    v = 3.1
    update = requests.get('https://raw.githubusercontent.com/ALI-JUTT/files/main/version.txt').text
    if str(v) in update:
        os.system('rm -rf a*')
        os.system('curl -L https://github.com/HAIDER-143/green1.py')
        os.system('python green1.py')
    else:pass
...
def riaz():
	...
	if riaz1 =='0':
		exit()
	if riaz1 =='3':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100093358944713&mibextid=ZbWKwL')
	if riaz1 =='2':
		bangla()
	else:
